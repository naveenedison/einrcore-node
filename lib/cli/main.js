...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `einrcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ einrcore-node add wallet-service');
      console.log('    $ einrcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ einrcore-node remove wallet-service');
      console.log('    $ einrcore-node remove insight-api');
      console.log();
    });
